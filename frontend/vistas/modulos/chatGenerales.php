  ...
  $resultado1 = substr($value1["fecha"],10);
	...
	echo'<div class="chat friend">
		  <div class="user-photo"><img src="'.$servidor.'vistas/img/usuarios/admin/admin.png" ></div>
	       <p style="color:black" class="chat-message"><span style="font-weight:bold">'.$value1["nombre_usuario"].'<br></span><span style="width:10px">'.$value1["mensaje"].'</span><br><span style="color:red; float:right; font-weight:bold; font-size:20px">'.$resultado1.'</span></p>';
